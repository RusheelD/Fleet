...
builder.Services.AddScoped<IMcpSecretProtector, McpSecretProtector>();
builder.Services.AddScoped<IMcpServerService, McpServerService>();
builder.Services.AddScoped<IMcpRuntimeConnector, McpRuntimeConnector>();
builder.Services.AddScoped<IMcpToolSessionFactory, McpToolSessionFactory>();
